...
class PresenceDetailsView extends GetView<PresenceDetailsController> {
  ...
  Widget build(BuildContext context) {
    ...
    String presenceIn =
        DateFormat('HH:mm:ss a').format(DateTime.parse(getUserHistory['masuk']['datetime']));
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        getUserHistory['masuk']['inArea'] == true ? "Didalam Area" : "Diluar Area",
                      ),
                      getUserHistory['masuk']['image'] != null
                          ? ClipRRect(
                              borderRadius: BorderRadius.circular(20),
                              child: SizedBox(
                                width: double.infinity,
                                child: Image.network(
                                  getUserHistory['masuk']['image'],
                                  fit: BoxFit.cover,
                                ),
                              ),
                            )
